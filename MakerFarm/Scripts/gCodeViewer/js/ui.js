...
//        chooseAccordion('layerAccordionTab');
    ...
    var printModelInfo = function(){
        ...
        resultSet.push("<input id=\"EstToolpathTime\" type=\"hidden\" value=\"" + parseInt(parseFloat(modelInfo.printTime)/60).toFixed() + "\" name=\"EstToolpathTime\"></input>");
...
//                myCodeMirror.setSelection({line:Number(gCodeLines.first),ch:0},{line:Number(gCodeLines.last),ch:0});
            ...
            this.worker = new Worker('/Scripts/gCodeViewer/js/Worker.js');
